      ...
      <Container>
        <Reveal className="flex flex-wrap items-end justify-between gap-4">
          ...
          <Link
            href={viewAllHref}
            className={cn(
              "text-[0.9375rem] font-medium text-primary underline decoration-[1.5px] underline-offset-[3px] transition-colors duration-300 hover:brightness-90 dark:text-dark-accent",
        ...
        <div className="mt-9 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {ministryItems.map((item, i) => (
            <Reveal key={item.key} index={i} className="h-full">
              <MinistryCard
