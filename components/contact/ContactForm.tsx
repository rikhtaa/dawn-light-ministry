...
export function ContactForm({
  ...
  function setField<K extends keyof typeof DEFAULT_FIELDS>(
    key: K,
    value: string,
  ) {
      ...
      >
        ...
        >
          <FormField
            ...
            error={
              state.status === "validationError" && state.errors?.name
                ? t.form.errors.name
                : undefined
            }
            isUrdu={isUrdu}
          ...
          <FormField
            ...
            error={
              state.status === "validationError" && state.errors?.email
                ? t.form.errors.email
                : undefined
            }
            isUrdu={isUrdu}
        ...
        >
          <div className="relative">
            ...
            >
              <option value={t.form.subjectOptions.general}>
                {t.form.subjectOptions.general}
              </option>
              <option value={t.form.subjectOptions.church}>
                {t.form.subjectOptions.church}
              </option>
              <option value={t.form.subjectOptions.seminary}>
                {t.form.subjectOptions.seminary}
              </option>
              <option value={t.form.subjectOptions.childrensEducation}>
                {t.form.subjectOptions.childrensEducation}
              </option>
              <option value={t.form.subjectOptions.resources}>
                {t.form.subjectOptions.resources}
              </option>
              <option value={t.form.subjectOptions.support}>
        ...
        <FormField
          ...
          error={
            state.status === "validationError" && state.errors?.message
