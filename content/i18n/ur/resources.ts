...
export const resources: Translated<ResourcesStrings> = {
  ...
  filters: {
    all: { value: "تمام", source: "author", published: true, reviewed: true, sourceHash: "a52ace420f2175d0" },
    sermons: { value: "خطبات", source: "author", published: true, reviewed: true, sourceHash: "37ad9d4c407fd2cd" },
    articles: { value: "مضامین", source: "author", published: true, reviewed: true, sourceHash: "b14ac78a46e90b71" },
    bibleStudies: { value: "بائبل اسٹڈیز", source: "author", published: true, reviewed: true, sourceHash: "fd51e22f54a9327f" },
    educationalMaterial: { value: "تعلیمی مواد", source: "author", published: true, reviewed: true, sourceHash: "90a3218579745d61" },
    books: { value: "کتب", source: "author", published: true, reviewed: true, sourceHash: "9da7f76bc81d2f4e" },
    english: { value: "انگریزی", source: "author", published: true, reviewed: true, sourceHash: "ba118bf7fc9c1aed" },
  ...
  row: {
    ...
    read: { value: "پڑھیں", source: "author", published: true, reviewed: true, sourceHash: "9b9a8d05a7ec353b" },
